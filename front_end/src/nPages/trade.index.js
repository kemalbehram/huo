...
import { nav } from 'nComponents/nav'; // 导航
nav();
...
window.TradingView.onready(function() {
    ...
    // let wsUrl = "wss://push.huocoin.com:8002";
    // 注册插件
    Vue.use(publicFn);
    Vue.use(https);
                        ...
                        message: (response) => {
                            ...
                            if (data && is(data, 'String') && data.indexOf('{') > -1) {
                                ...
                                // 交易 频道
                                    ...
                                    document.getElementsByTagName("title")[0].innerText = parseFloat(this.orders.price) + ' | ' + `${this.coinFrom}`.toUpperCase() + '/' +
                                        `${this.realArea}`.toUpperCase();
                                }
                            }
                        },
                        close: (data) => {
