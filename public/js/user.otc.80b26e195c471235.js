...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_nPages_user_otc_js__ = __webpack_require__(845);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise__ = __webpack_require__(210);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_nStyle_user_otc_otc_scss__ = __webpack_require__(846);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_nStyle_user_otc_otc_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_nStyle_user_otc_otc_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_vue__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_nComponents_nav__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_nComponents_jsjAlert__ = __webpack_require__(640);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_axios__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_axios__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_lrz__ = __webpack_require__(202);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_lrz___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9_lrz__);
...
var otc = new __WEBPACK_IMPORTED_MODULE_5_vue__["a" /* default */]({
    data: function data() {
        return {
    ...
    mounted: function mounted() {
        Object(__WEBPACK_IMPORTED_MODULE_6_nComponents_nav__["b" /* nav */])();
    },

    methods: {
        //tab 切换
        tabChange: function tabChange(index, coin) {
            var _this = this;

            this.index = index;
            this.alertMsg = this.showStatus = '';
            this.$http.post('/ajax_user/getOtcUserWalletList', { 'coin': coin.toLowerCase() }).then(function (res) {
                _this.coinList = res.data.coinList;
                // console.log('tag222',coinList);
                if (res.status) {
                    var arrData = res.data.walletList;
                    for (var i = 0; i < arrData.length; i++) {
                        if (arrData[i].type == 1) {
                            otc.addresData = arrData[i];
                        }
                        if (arrData[i].type == 2) {
                            otc.wcg = arrData[i];
                        }
                    ...
                    _this.errStatus.imgErr = '√';
                    _this.imgStatus = "true";
                } else {
                    _this.addresData.img = '/imgs/zw.png';
                    _this.addresData.address = '';
                    _this.imgStatus = "";
                }
        ...
        // 点击提交
        submit: function submit(subData) {
            var _this3 = this;
                ...
                return __WEBPACK_IMPORTED_MODULE_1_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                if (!(!_this3.verify('pwd', subData, 'tradepwd', '請輸入正確的交易密码!') || !_this3.verify('address', subData, 'address', '請輸入正確的收币地址！') || subData == 'wcg' && !_this3.verify('address', subData, 'numbers', '请输入正确的WCG公钥') || subData == 'eunex' && !_this3.verify('address', subData, 'numbers', '请输入正确的EUNEX账号') || subData == 'mbaex' && !_this3.verify('address', subData, 'numbers', '请输入正确的MBAEX的UID'))) {
                                    _context.next = 2;
                                    break;
                                }
                            ...
                            case 2:
                                _this3.$http.post('/ajax_user/validateTradepwd', { tradepwd: _this3[subData].tradepwd }).then(function (res) {
                                    if (res.status) {
                                        _this3[subData].tradepwd = '';
                                        _this3.showAlert = true;
                                        _this3.submitData = subData;
                                        // otc.OtcUserTest(subData);
                                    } else {
                                        _this3.alertMsg = res.msg;
                                        setTimeout(function () {
                                            _this3.alertMsg = "";
                                        }, 2000);
                                    }
                                }).catch(function (err) {
                                    _this3.alertMsg = '请求超时';
                                    setTimeout(function () {
                                        _this3.alertMsg = "";
                                    }, 2000);
                                });
        ...
        // 提交数据
        submitFun: function submitFun(postData) {
            var _this4 = this;

            // console.log('OtcUserTest==',postData,otc[postData]);
            __WEBPACK_IMPORTED_MODULE_8_axios___default.a.post('/ajax_user/otcUserWallet', qs.stringify(otc[postData])).then(function (res) {
                if (res.status) {
                    _this4.showAlert = false;
                    // console.log('res',res.data.data.id)
                    if (res.data.data.id != undefined) {
                        _this4[postData].id = res.data.data.id;
                    }
        ...
        lrzImg: function lrzImg(file) {
            return new __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a(function (resolve) {
                // 压缩 图片
                __WEBPACK_IMPORTED_MODULE_9_lrz___default()(file, { width: 800, quality: 0.6 }).then(function (rst) {
                    resolve(rst);
                }).catch(function (err) {
        ...
        uploadFile: function uploadFile(e) {
            ...
            this.lrzImg(trageFile).then(function (result) {
                if (result.base64Len > imgMaxSize) {
                    _this5.errStatus.imgErr = '文件过大!';
                    _this5.imgStatus = false;
                    return false;
                } else {
                    _this5.errStatus.imgErr = '√';
                    //转换为base64 进行输出
                    _this5.addresData.img = result.base64;
                    _this5.imgStatus = true;
                }
            });
        },
        ...
        offFun: function offFun(da) {
            var _this6 = this;

            if (!this[da].id) return false;
            // console.log('tag2222222', this[da])
            this.$http.post('/ajax_user/modifyWallet', { 'wallet_id': this[da].id, 'coin': this[da].coin.toLowerCase(), status: this[da].status == 1 ? 2 : 1 }).then(function (res) {
                if (res.status) {
                    _this6[da].status = _this6[da].status == 1 ? 2 : 1;
                };
            }).catch(function (err) {
                _this6.alertMsg = "請求超時！";
                setTimeout(function () {
                    _this6.alertMsg = "";
                }, 2000);
            });
...
//# sourceMappingURL=user.otc.80b26e195c471235.js.map