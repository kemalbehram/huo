...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_nPages_user_realinfo__ = __webpack_require__(807);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_regenerator__ = __webpack_require__(208);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_regenerator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_regenerator__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_asyncToGenerator__ = __webpack_require__(209);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_asyncToGenerator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_asyncToGenerator__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_babel_runtime_core_js_promise__ = __webpack_require__(210);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_babel_runtime_core_js_promise___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_babel_runtime_core_js_promise__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_babel_runtime_core_js_object_assign__ = __webpack_require__(94);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_nStyle_init_scss__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_nStyle_init_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_nStyle_init_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_nStyle_theme_scss__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_nStyle_theme_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_nStyle_theme_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_nStyle_user_common_scss__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_nStyle_user_common_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_nStyle_user_common_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_nStyle_user_realinfo_user_realinfo_scss__ = __webpack_require__(808);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_nStyle_user_realinfo_user_realinfo_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_nStyle_user_realinfo_user_realinfo_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_vue__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_plugins_http__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_nComponents_nav__ = __webpack_require__(25);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_lrz__ = __webpack_require__(202);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_lrz___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_14_lrz__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_qs__ = __webpack_require__(76);
...
__WEBPACK_IMPORTED_MODULE_9_vue__["a" /* default */].use(__WEBPACK_IMPORTED_MODULE_10_plugins_http__["a" /* default */]);
...
var realinfo = new __WEBPACK_IMPORTED_MODULE_9_vue__["a" /* default */]({
    data: function data() {
        return {
    ...
    mounted: function mounted() {
        Object(__WEBPACK_IMPORTED_MODULE_11_nComponents_nav__["b" /* nav */])();
        this.creatTimes();
    },
    ...
    methods: {
        ...
        getInfo: function getInfo() {
            ...
            this.$http.post('/Ajax_User/userstatus', {}).then(function (_ref) {
                var data = _ref.data,
                    status = _ref.status,
                    msg = _ref.msg;
                ...
                if (status == 1 && data == '') {
                    ...
                    if (_status == 1 || _status == 2 || _status == 3) {
                        ...
                        var name = data.name,
                            ...
                            handkeep = data.handkeep,
                            idcardyi = data.idcardyi;
                        //数据填充

                        _this.postData.name = name;
                        _this.postData.cardtype = cardtype;
                        _this.postData.idcard = idcard;

                        if (_status == 2) {
                            _this.postData.idcard = idcardyi;
                            _this.createTime = data.created;
                        }
                        //去掉输出图片前面的 .
                        _this.imgs.baseyi = frontFace.replace('./', '/');
                        _this.imgs.baseer = backFace.replace('./', '/');
                        _this.imgs.basesan = handkeep.replace('./', '/');
                        _this.frontFaceStatus = 2;
                        _this.backFaceStatus = 2;
                        _this.handkeepStatus = 2;
                        //将原始数据储存在this.oldData
                        __WEBPACK_IMPORTED_MODULE_4_babel_runtime_core_js_object_assign___default()(_this.oldData, data);
                        if (_status == 3) {
                    ...
                    _this.errMesAlert = msg;
                }
            });
        },

        //图片压缩
        lrzImg: function lrzImg(file) {
            ...
            return new __WEBPACK_IMPORTED_MODULE_3_babel_runtime_core_js_promise___default.a(function (resolve) {
                // 压缩 图片
                __WEBPACK_IMPORTED_MODULE_14_lrz___default()(file, {
                    width: 800,
                    quality: 0.6
                }).then(function (rst) {
                    resolve(rst);
        ...
        uploadFile: function uploadFile(e) {
            ...
            var imgMaxSize = 2097152;
            var trageFile = e.target.files[0]; //图片
            var name = e.target.name; //图片名
            var size = trageFile.size; //图片大小
            this.lrzImg(trageFile) //压缩图片
            .then(function (result) {
                if (result.base64Len > imgMaxSize) {
                    _this2.nowStatus = true;
                    _this2.errMesAlert = language['PIC_SIZE_MAX'];
                    return false;
                } else {
                    var type = result.file.type;
                    //图片上传格式
                    if (type) {
                        switch (type) {
                            case 'image/jpg':
                            ...
                            default:
                                _this2.nowStatus = true;
                                _this2.errMesAlert = language['PIC_FORMAT_ERROR'];
                                return false;
                        }
                    } else {
                        _this2.nowStatus = true;
                    ...
                    //转换为base64 进行输出
                    if (name === 'frontFace') {
                        _this2.imgs.baseyi = result.base64;
                        _this2.frontFaceStatus = 2;
                    } else if (name === 'backFace') {
                        _this2.imgs.baseer = result.base64;
                        _this2.backFaceStatus = 2;
                    } else {
                        _this2.imgs.basesan = result.base64;
                        _this2.handkeepStatus = 2;
                    }
                }
            });
        },
        ...
        verify: function verify(type, now) {
            console.log('verify数据校验', type);
            var regName = /(^[\u4e00-\u9fa5]{1}[\u4e00-\u9fa5·]{0,98}[\u4e00-\u9fa5]{1}$)|(^[a-zA-Z]{1}[a-zA-Z\s]{0,98}[a-zA-Z]{1}$)/;
            var idcard1 = /^[1-9]\d{5}(18|19|([23]\d))\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$/;
            var idcard2 = /^[a-zA-Z\d\-\.]{1,20}$/;
            var idcard3 = /^[a-zA-Z\d]{1,30}$/;
            switch (type) {
                case 'name':
                ...
                case 'idcard':
                    ...
                    if (this.postData.idcard) {
                        var types = this.postData.cardtype;
        ...
        //判断数据是否发生改变
        //输入框部分
        changesInput: function changesInput(type) {
        ...
        //图片部分
        changesImg: function changesImg(type) {
            console.log('changesImg 图片部分--判断数据', type);
            var yi = this.oldData.frontFace.replace('./', '/');
            var er = this.oldData.backFace.replace('./', '/');
            var san = this.oldData.handkeep.replace('./', '/');
            switch (type) {
                case 'baseyi':
        ...
        //清楚上传的图片
        picClose: function picClose(type) {
        ...
        //验证提交的信息
        submitVerify: function submitVerify(type) {
            var _this3 = this;

            console.log('submitVerify', type);
            return new __WEBPACK_IMPORTED_MODULE_3_babel_runtime_core_js_promise___default.a(function (resolve) {
                __WEBPACK_IMPORTED_MODULE_4_babel_runtime_core_js_object_assign___default()(_this3.postData, _this3.imgs);
                // 重新提交跳转 避免进行数据验证
                if (!type && _this3.submitNow) {
                    //避免再次提交后 为false
                    // this.submitNow = true;
                    for (var i in _this3.postData) {
                        if (_this3.verify(i) === false) {
                            _this3.submitNow = false;
                        }
                    }
                } else {
                    _this3.submitNow = false;
        ...
        //提交选择
        submitChoose: function submitChoose(url) {
            var _this4 = this;

            console.log('submitChoose提交选择', url);
            return new __WEBPACK_IMPORTED_MODULE_3_babel_runtime_core_js_promise___default.a(function (resolve) {
                if (_this4.submitNow) {
                    _this4.submitNow = false;
                    if (_this4.status == '' && !_this4.failAgain) {
                        url = '/Ajax_Auth/phone';
                        _this4.ajaxPost(url);
                    } else if (_this4.status == 1) {
                        url = '/Ajax_Auth/mobilephone';
                        var result = false;
                        var str = '';
                        for (var i in _this4.postData) {
                            if (_this4.changesImg(i) === true || _this4.changesInput(i) === true) {
                                result = true;
                            } else if (_this4.changesImg(i) === false) {
                                //没改变的图片传空值
                                _this4.postData['' + i] = '';
                            }
                            str += i + ':' + _this4.postData[i] + ',';
                        }
                        resolve({
                            result: result,
                            url: url,
                    ...
                    } else if (_this4.status == '' && _this4.failAgain) {
                        url = '/Ajax_Auth/mobilephone';
                        _this4.ajaxPost(url);
                    }
                }
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 5:
                                ...
                                _context.next = 8;
                                return _this5.submitVerify(type);

                            case 8:
                                _context.next = 10;
                                return _this5.submitChoose(url);
        ...
        ajaxPost: function ajaxPost(url) {
            ...
            this.$http({
                ...
                _this6.submitNow = true;
                if (status == 1) {
                    _this6.alertype = 'realinfoSucc';
                }
                ...
                var data = "";
                if (_this6.postData) {
                    data = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(_this6.postData);
                }
                var resultErr = {};
                resultErr.reqUrl = url;
                resultErr.response = error;
                resultErr.param = data;
                _this6.writeDown(resultErr);
            });
        },

        //log
        writeDown: function writeDown(errResult) {
            console.log('writeDown', errResult);

            var errEnc = errResult ? this.$jsencrypt(errResult) : '';
            var headers = {};
            headers['Content-Type'] = 'application/x-www-form-urlencoded; charset=UTF-8';
            this.$http.post('/ajax_common/reqFailedLog', __WEBPACK_IMPORTED_MODULE_15_qs___default.a.stringify(errEnc, {
        ...
        //时间戳
        creatTimes: function creatTimes(value) {
...
/* unused harmony default export */ var _unused_webpack_default_export = (realinfo);
...
//# sourceMappingURL=user.realinfo.6344e31c908f15e7.js.map