...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_nPages_index_index_js__ = __webpack_require__(674);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_nStyle_index_index_scss__ = __webpack_require__(675);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_nStyle_index_index_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_nStyle_index_index_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_plugins_http__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_nComponents_Alert__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash__ = __webpack_require__(98);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_filters_filters__ = __webpack_require__(139);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__nComponents_nav__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__utils_progressive__ = __webpack_require__(743);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_nStyle_swiper_reset_scss__ = __webpack_require__(747);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_nStyle_swiper_reset_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_nStyle_swiper_reset_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_swiper_dist_js_swiper_js__ = __webpack_require__(748);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_swiper_dist_js_swiper_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9_swiper_dist_js_swiper_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__libs_bannerAnimation__ = __webpack_require__(749);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_nComponents_register__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_vue_gemini_scrollbar__ = __webpack_require__(236);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_vue_gemini_scrollbar___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_12_vue_gemini_scrollbar__);
...
Object(__WEBPACK_IMPORTED_MODULE_6__nComponents_nav__["b" /* nav */])();





__WEBPACK_IMPORTED_MODULE_1_vue__["a" /* default */].use(__WEBPACK_IMPORTED_MODULE_2_plugins_http__["a" /* default */]);

__WEBPACK_IMPORTED_MODULE_1_vue__["a" /* default */].use(__WEBPACK_IMPORTED_MODULE_12_vue_gemini_scrollbar___default.a);

var lazyload = new __WEBPACK_IMPORTED_MODULE_7__utils_progressive__["a" /* default */]({
    el: '#bannerContainer',
    lazyClass: 'lazy',
    removePreview: true,
    scale: true
...
function createSwiper() {
    return new __WEBPACK_IMPORTED_MODULE_9_swiper_dist_js_swiper_js___default.a('#bannerContainer', {
        loop: true,
        // autoplay: 1000,
        autoplay: true,
...
var index = new __WEBPACK_IMPORTED_MODULE_1_vue__["a" /* default */]({
    data: function data() {
        return {
            getHeight: '',
            //无数据
    ...
    mounted: function mounted() {
        Object(__WEBPACK_IMPORTED_MODULE_10__libs_bannerAnimation__["a" /* default */])('particles');
        if (this.$refs.login) {
    ...
    methods: {
        getList: function getList(num) {
            ...
            var count = 0;
            this.$http.get('/ajax_market/getAllQuoteV2').then(function (_ref) {
                var data = _ref.data,
                    msg = _ref.msg,
                    status = _ref.status;

                __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.forEach(data, function (mark, key, index) {

                    //存储币种排序
                    _this.coinNum[count] = key;
                    count++;
                    //
                    __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.forEach(mark, function (elem) {
                        elem.selected = '';
                    });
                });
        ...
        //表格tab切換
        tabChange: function tabChange(index, type) {
            var _this2 = this;
            ...
            if (this.indexs != 1) {
                ...
                __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.forEach(this.coinListNum, function (val) {
                    if (_this2.chooseArray.includes(val.coin)) {
                        val.selected = 1;
                    } else {
                        val.selected = 0;
                    }
        ...
        //获取自选
        getmySelf: function getmySelf(num) {
            var _this3 = this;
            ...
            if (this.login == 1) {
                ...
                this.$http.get('/ajax_user/selected').then(function (_ref2) {
                    ...
                    if (status == 1) {
                        if (data) {
                            _this3.chooseArray = __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.split(data, ',');
                        } else {
                    ...
                    if (num == 1) {
                        var len = __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.findIndex(_this3.coinNum, function (val) {
                            return val == 'dob';
                        });
                        _this3.tabChange(len + 2, 'dob');
                    }
                });
            } else {
                //没有登陆
                var star = sessionStorage.star;
                if (star) {
                    //sessionStorage中有数据
                    this.chooseArray = __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.split(sessionStorage.star, ',');
                    //避免数组内部有空值
                    this.chooseArray = __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.remove(this.chooseArray, function (val) {
                        return val != '';
                    });
                } else {
                    //sessionStorage中没有数据
                ...
                if (num == 1) {
                    var len = __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.findIndex(this.coinNum, function (val) {
                        return val == 'dob';
                    });
        ...
        //点击自选
        clickMySelf: function clickMySelf(coin, index) {
            var _this4 = this;
            ...
            if (this.login == 1) {
                ...
                this.$http.post('/ajax_user/setSelected', { coins: coin, type: type }).then(function (_ref3) {
                    var data = _ref3.data,
                        status = _ref3.status,
                        msg = _ref3.msg;

                    if (status != 1) {
                        _this4.nowStatus = false;
                ...
                if (star) {
                    ...
                    if (star.includes(coin)) {
                        coinAll = __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.split(star, ',');
                        //删除对应币
                        coinAll = __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.remove(coinAll, function (val) {
                            return val != coin;
                        });
                        coinAll = __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.join(coinAll, ',');
        ...
        forEachData: function forEachData() {
            var _this5 = this;
            ...
            if (this.searchInpt) {
                ...
                __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.forEach(this.chooseArray, function (value, index) {
                    if (value) {
                        var names = value.split('_')[1];
                        var Arrays = _this5.coinList['' + names];
                        var newArr = _this5.coinList.new;
                        //普通交易区
                        var ind = __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.findLastIndex(Arrays, function (val) {
                            var vals = val.coin;
                            return val.coin == value;
                        });

                        //创新区
                        var indNew = __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.findLastIndex(newArr, function (val) {
                            var vals = val.coin;
                            return val.coin == value;
                        });

                        if (ind > -1) {
                            _this5.coinListNum[index] = Arrays['' + ind];
                            _this5.coinListNum[index].selected = 1;
                            _this5.newList[index] = Arrays['' + ind];
                        }

                        if (indNew > -1) {
                            _this5.coinListNum[index] = newArr['' + indNew];
                            _this5.coinListNum[index].selected = 1;
                            _this5.newList[index] = newArr['' + indNew];
                        }
                    }
                });
            }
        ...
        forEachCoin: function forEachCoin(index) {
        ...
        //限制8位数
        spliceEight: function spliceEight(val) {
            if (val) {
                val = val.slice(0, 10);
                var newArr = val.indexOf('.');
                if (newArr > 0 && __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.size(val) == newArr) {
                    val = val.replace('.', '');
                }
                return val;
            }
        ...
        //计算人民币
        moneyCal: function moneyCal(rmb, price, num) {
            if (!rmb) rmb = 0;
            if (!price) price = 0;
            if (!num) num = 0;
            if (Object(__WEBPACK_IMPORTED_MODULE_5_filters_filters__["d" /* toFixedNum */])(price, 8) == 0) {
                return 0;
            } else {
                return Object(__WEBPACK_IMPORTED_MODULE_5_filters_filters__["d" /* toFixedNum */])(Object(__WEBPACK_IMPORTED_MODULE_5_filters_filters__["d" /* toFixedNum */])(rmb, 8) / Object(__WEBPACK_IMPORTED_MODULE_5_filters_filters__["d" /* toFixedNum */])(price, 8) * Object(__WEBPACK_IMPORTED_MODULE_5_filters_filters__["d" /* toFixedNum */])(num, 8));
            }
        },
        ...
        searchBtn: function searchBtn() {
            this.search = false;
            var len = 0;
            if (__WEBPACK_IMPORTED_MODULE_4_lodash___default.a.size(this.coinListNum)) {
                this.searchData();
            }
        },
        ...
        searchData: function searchData() {
            ...
            if (this.searchInpt) {
                //搜索框有值
                this.coinListNum = __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.filter(this.newList, function (o) {
                    var val = o.coin.split('_')[0];
                    return val.indexOf(_this6.searchInpt.toLocaleLowerCase()) != -1;
                });
                if (__WEBPACK_IMPORTED_MODULE_4_lodash___default.a.size(this.coinListNum) == 0) {
                    this.loading = false;
                }
        ...
        order: function order(type, now) {
            ...
            if (!this.orderFn) {
                //升序
                this.coinListNum = __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.orderBy(this.coinListNum, function (val) {
                    if (val && type != 'coin') {
        ...
        //针对自选部分币种单独排序
        //币种为一块
        selfOrder: function selfOrder() {
            var _this7 = this;

            var arrays = [];
            var newArr = [];
            __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.forEach(this.coinNum, function (val, index) {
                arrays[index] = __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.filter(_this7.coinListNum, function (coins) {
                    if (coins) {
                        return val == coins.coin.split('_')[1];
                    }
                });
                newArr = __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.concat(newArr, arrays[index]);
            });
            this.coinListNum = newArr;
        },
        getCoin: function getCoin(e) {
            var _this8 = this;

            var url = '/ajax_user/coinGift';
            //点击的为button
            if (e.target.tagName == 'BUTTON') {

                if (this.login == 1) {
                    var type = this.$refs.buttons.dataset.type;
                    var coinName = this.$refs.buttons.dataset.name;
                    if (type) {
                        url = '/ajax_user/coin' + type;
                    }
                    this.$http.post(url, { coin: coinName }).then(function (_ref4) {
                        var data = _ref4.data,
                            status = _ref4.status,
                            msg = _ref4.msg;
        ...
        erIn: function erIn(type) {
            this.showEr[type] = true;
        },
        erOut: function erOut(type) {
        ...
        getRedPacket: function getRedPacket() {
            ...
            this.$http('ajax_user/mccactivity').then(function (res) {
                ...
                if (parseInt(status) === 1) {
                    _this9.actType = data;
                    _this9.activeMsg = msg.replace(/((,|，).+)$/g, '');
                }
                // 活動結束
                else if (res.data) {
                        ...
                        _this9.errMesAlert = msg;
                    }
                _this9.actGetting = false;
            }).catch(function (e) {
                _this9.actGetting = false;
                if (e) console.log(e);
            });
        },
        winAjax: function winAjax() {
            var _this10 = this;

            this.$http.get('/News/getNewsTopInfo').then(function (res) {
                if (res.status) {
                    _this10.winHtml.header = res.data.title;
                    _this10.winHtml.body = res.data.content;
                }
            }).catch(function (err) {
                console.log(err);
            });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__index_scss__ = __webpack_require__(746);
...
var Progressive = function () {
  function Progressive(option) {
    var _this = this;

    __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default()(this, Progressive);
    ...
    this.lazy = this.Util.throttle(function (_) {
      _this.fire();
    }, 300);
  ...
  __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default()(Progressive, [{
    key: 'fire',
    value: function fire() {
    ...
    key: 'events',
    value: function events(el, bind) {
      var _this2 = this;

      if (bind) {
        this.EVENTS.forEach(function (evt) {
          _this2.Util.on(el, evt, _this2.lazy);
        });
      } else {
        this.EVENTS.forEach(function (evt) {
          _this2.Util.off(el, evt, _this2.lazy);
        });
      }
    }
  }, {
    ...
    key: 'mountImage',
    value: function mountImage(preview, img) {
      var _this4 = this;
...
/* harmony default export */ __webpack_exports__["a"] = (Progressive);
...
var banners = function banners(id) {
  var option = {
    particles: {
      number: {
        value: 300,
...
/* harmony default export */ __webpack_exports__["a"] = (banners);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(65), __webpack_require__(99)(module)))
...
//# sourceMappingURL=index.index.b578a91f1d69bc09.js.map