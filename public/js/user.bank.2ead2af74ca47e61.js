                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                if (!(_this4.postData.index == 1 && (!_this4.verify('regStr', 'BankData', 'username', '請輸入正確的開戶支行') || !_this4.verify('regStr', 'BankData', 'name', '請輸入正確的備註名稱') || !_this4.verify('bank', 'BankData', 'bankcard', '請輸入正確的銀行卡號') || !_this4.verify('moble', 'BankData', 'moblePhone', '請輸入正確的短信驗證碼!')) || _this4.postData.index == 2 && (!_this4.verify('moble', 'postData', 'moblePhone', '請輸入正確的短信驗證碼!') || !_this4.verify('wx', 'postData', 'bankcard', '請輸入正確的微信賬號！')) || _this4.postData.index == 3 && (!_this4.verify('moble', 'postData', 'moblePhone', '請輸入正確的短信驗證碼!') || !_this4.verify('zfb', 'postData', 'bankcard', '請輸入正確的支付寶賬號！')))) {
                                    _context.next = 2;
                                    break;
                                }
...
//# sourceMappingURL=user.bank.2ead2af74ca47e61.js.map