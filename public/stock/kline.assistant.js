...
Kline.prototype = {
    ...
    websocketRedister: function(symbol) {
        var $this = this;
    		// $.get('/Ajax_Market/depths?depth=' + symbol + '&v=' + Math.random(), function(result) {
    		//     $this.updateDepth(result);
    		// });
		// setInterval(function() {
		//     $.get('/Ajax_Market/depths?depth=' + coinCode + '&v=' + Math.random(), function(result) {
		// 		$this.updateDepth(result);
		// 	});
        // }, 2000);
        // parent.canvasReTime
    ...
    isArray: function(target) {
      ...
      return type.indexOf('Array') !== -1 ? true : false;
    },
    ...
    getgview: function(c) {
        if (!c && Object.prototype.toString.call(c).indexOf('Array') === -1) {
          return;
        }
        var d = "";
        var e;
    ...
    getgasks: function(j) {
        ...
        if (Array.prototype.toString.call(j).indexOf('Array') === -1) {
          return;
        }
    ...
    isBtc123: function() {
        ...
        if (this.symbol && this.symbol.indexOf("btc123") >= 0) {
            return true
        } else {
            return false
        }
