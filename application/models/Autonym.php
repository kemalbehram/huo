...
class  AutonymModel extends Orm_Base{
    ...
    public $field = array(
        ...
        'pannumber' => array('type' => "varchar(60) unsigned", 'comment' => 'PAN NUMBER'),
        'aadhaarnumber' => array('type' => "varchar(60) unsigned", 'comment' => 'AADHAAR NUMBER'),
        'pannumberphoto' => array('type' => "varchar(60) unsigned", 'comment' => 'PAN NUMBER PHOTO'),
