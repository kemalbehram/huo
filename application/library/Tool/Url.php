...
class Tool_Url{
    ...
    public static function  getDomain(){
        $domain = '';
        if(false !== strpos($_SERVER['SERVER_NAME'], 'huocoin.com') || $_SERVER['SERVER_NAME']=='localhost'){
            $domain = 'huocoin.com';
        } elseif (false !== strpos($_SERVER['SERVER_NAME'], 'huocoin.vip')){
            $domain = 'huocoin.vip';
        } elseif (false !== strpos($_SERVER['SERVER_NAME'], 'huocoin.wang')){
            $domain = 'huocoin.wang';
        }elseif (false !== strpos($_SERVER['SERVER_NAME'], 'huowang.top')){
            $domain = 'huowang.top';
        }else{
