...
class Api_Rpc_CoinClient
{
	...
	public function __call($method, array $params)
	{
		...
		self::debug1(array('method' => $method, 'params' => $params, 'res' => $res), 'Api_Rpc_CoinClient execute');
	...
	protected function debug($str)
	{
		...
		self::debug1($str, 'Api_Rpc_CoinClient');
	}
    ...
    static function debug1($value, $type = 'DEBUG', $verbose = false, $encoding = 'UTF-8')
    {
//        if (APP_DEBUG || 1) {
//            if (!IS_CLI) {
