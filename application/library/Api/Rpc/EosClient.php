...
//        echo $method;die;
    ...
    {
        $url = $this->host . ':' .$this->port . '/v1/wallet/' . $method;
        $ret = $this->request($url, $params);
        return $ret;
    }
...
//json转换成二进制
    ...
    {
        $res = $this->get_request(__FUNCTION__,
            $account_token
        );
        return $res;
    }
...
//二进制转换成json
    ...
    {
//        echo $this->host;die;
        $open = $this->open($wallet);
        $unlock = $this->unlock($wallet_account, $ealletp);
