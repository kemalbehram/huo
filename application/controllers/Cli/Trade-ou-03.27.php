...
class Cli_TradeController extends Ctrl_Cli
{
    ...
    {
        $models = array('Order_Coin', 'Trust_Coin', 'User', 'Address', 'FreeTradeUser','DayBeforeCount','Coin_Pair','FeeBonus');//,'AssetDetail'
        foreach ($models as $v)
        {
            $m               = $v . 'Model';
