 ...
 *  钱包轮询
 */
class Cli_WalletcountController extends Ctrl_Cli
{
    ...
    public function  bitAction($coin){
        ...
        try{
            ...
            $listtransactions = $rpcMo->listtransactions('*', 1000, 0);
            ...
            foreach ($listtransactions as $trans) {
                ...
                if ($trans['category'] == 'receive') {
                    ...
                    Tool_Log::clog(json_encode($trans),$coin);
...
//                        }
    ...
    public function eosAction($coin){
        ...
        try{
            ...
            if(!$block_info) Tool_Del::lock($lockfile,'轮询出错');
...
//        Tool_Out::p($block_info);die;
            ...
            foreach ($block_info as $k=>$v) {
                ...
                $final_amount = trim(substr($token_data['quantity'], 0, strlen($token_data['quantity']) - 3));
