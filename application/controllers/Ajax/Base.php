...
class Ajax_BaseController extends Ctrl_Base
{
	...
	public function init()
	{
		...
		if(in_array($this->_request->action,array("issettradepwd","checktradepwd",'xcxoutcoin','mobilephone','phone','rgbcancel','otcuserwallet','v1','invite','invitebonus','invitebonusdetail','captchaverify')))  //实名接口不加密
		{
	...
	protected function ajax($pMsg = '', $pStatus = 0, $pData = '', $pType = 'json'){
        ...
        if(isset($this->mCurUser['uid'])) Tool_Lock::del($this);
